...
class user extends React.Component {
	...
	render() {
		return (
          ...
          <bp3.Overlay isOpen={this.state.overlay} onClose={this.toggleOverlay} canOutsideClickClose={true} canEscapeKeyClose={true} enforceFocus>
            <div className='w-full h-full flex center'>
            <bp3.Card className='pad-1'>
              <bp3.Button text="add" intent={bp3.Intent.DANGER}></bp3.Button>
              <bp3.Button text="add" intent={bp3.Intent.PRIMARY}></bp3.Button>
              </bp3.Card>
            </div>
            </bp3.Overlay>
				</div>
